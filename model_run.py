...
prune_brevitas_model(model, conv_feature_index=8, SIMD=4, NumColPruned=pruning_amount)
prune_brevitas_model(model, conv_feature_index=11, SIMD=4, NumColPruned=pruning_amount)
prune_brevitas_model(model, conv_feature_index=15, SIMD=4, NumColPruned=pruning_amount)
prune_brevitas_model(model, conv_feature_index=18, SIMD=4, NumColPruned=pruning_amount)
