...
from torch.nn.utils.prune import _validate_pruning_amount_init, _validate_structured_pruning, _validate_pruning_dim, \
...
class LnFineSIMDStructured(BasePruningMethod):
    ...
    def apply(cls, module, name, SIMD_in, SIMD_out, n, enforce_FINN_compatibility):
        ...
        return super(LnFineSIMDStructured, cls).apply(
            module, name, SIMD_in=SIMD_in, SIMD_out=SIMD_out, n=n,
            enforce_FINN_compatibility=enforce_FINN_compatibility, amount=1 - (SIMD_out / SIMD_in),
        )
