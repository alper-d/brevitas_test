...
CNV_OUT_CH_POOL = [(64, False), (64, True), (128, False), (128, False), (256, False), (256, False), (256, False), (512, False), (512, False)]
    ...
    def __init__(self, num_classes, weight_bit_width, act_bit_width, in_bit_width, in_ch):
        ...
        for i, (out_ch, is_pool_enabled) in enumerate(CNV_OUT_CH_POOL):
            self.conv_features.append(
                QuantConv2d(
                    kernel_size=KERNEL_SIZE if not i + 1 == len(CNV_OUT_CH_POOL) else LAST_LAYER_KERNEL_SIZE,
                    in_channels=in_ch,
                    out_channels=out_ch,
                    bias=False,
...
def cnv(cfg):
    def get_model_cfg(name):
        ...
        config_path = os.path.join(current_dir, 'models_folder', 'cfg', name.lower() + '.ini')
